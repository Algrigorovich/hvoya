...
function copyVideo() {
  return gulp.src(dirs.src.video).pipe(gulp.dest(dirs.dist.video))
}

function copyPublicAssets() {
  return gulp.src(dirs.public).pipe(gulp.dest(dirs.dist.root))
}
...
/* ---------- HELPERS ---------- */
function clean(cb) {
  return gulp.src(dirs.dist.root).pipe(rimraf())
}
